...
/*
	Contains functions that handle each of the REST calls and returns response if error
	Displays message to user if an error exists
	get, create, update, and delete user (CRUD operatoins)
*/
import (
	"aws-lambda-go-starter/pkg/user"
	"net/http"
